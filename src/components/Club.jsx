            ...
            <>
              <div>
                <div
                  ...
                  className="   md:my-0 my-7 flex flex-col  font-semibold hover:cursor-pointer ${isActive ? 'text-blue-400' : 'text-gray-400'}"
                >
                  {link.club}
                  <div className=" h-1 w-28 mx-auto bg-black hover:bg-blue-500 "></div>
